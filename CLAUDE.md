...
## Git
- Всю работу с Git и GitHub делаешь сам — я вручную в GitHub не захожу.
- Коммитишь и пушишь в рабочую ветку сессии сам, без подтверждения.
- В `main` — только через PR: открываешь и мерджишь сам после моего ок.
